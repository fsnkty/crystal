...
let
  mynv = let
    con = pkgs.neovimUtils.makeNeovimConfig {
      plugins = builtins.attrValues {
        inherit (pkgs.vimPlugins)
          nvim-lspconfig null-ls-nvim nvim-treesitter nvim-tree-lua
          nvim-web-devicons;
    ...
    wrapperArgs = let
      path =
        lib.makeBinPath [ pkgs.deadnix pkgs.statix pkgs.nil pkgs.alejandra ];
    in con.wrapperArgs ++ [ "--prefix" "PATH" ":" path ];
